    ...
    <>
      ...
      <div className="position-sticky top: 2rem;">
        <div className="p-4 mb-3 bg-body-tertiary rounded">
          ...
          <p className="mb-0">DecaBlog is more than just a collection of articles; it's a community where ideas are shared, discussions are sparked, and connections are made. We invite you to join us on this journey of exploration and learning. Whether you're here for expert insights, engaging stories, or practical tips, we aim to be your go-to destination for latest trends.
           Our team here at DecaBlog is dedicated to crafting articles that go beyond the surface, delving into the heart of topics to provide you with valuable perspectives and knowledge.</p>
        </div>
