...
exports.registerSchema = joi_1.default.object().keys({
    email: joi_1.default.string().lowercase().email({ minDomainSegments: 2, tlds: { allow: ['com', 'net'] } }).required(),
    ...
    confirmpassword: joi_1.default.equal(joi_1.default.ref('password')).required(),
});
